...
const getBooks = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: book_constraint_1.bookSearchableFields.map((field) => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive'
                }
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map((key) => {
                if (book_constraint_1.bookRelationalFields.includes(key)) {
                    return {
                        [book_constraint_1.bookRelationalFieldsMapper[key]]: {
                            id: filterData[key]
                        }
                    };
                }
