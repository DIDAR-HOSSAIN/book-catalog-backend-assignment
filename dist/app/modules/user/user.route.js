...
router.patch('/:id', (0, validateRequest_1.default)(user_validation_1.UserZodValidation.updateUserZodSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), user_controller_1.UserController.updateUser);
